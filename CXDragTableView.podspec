...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CXDragTableView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/616704162@qq.com/CXDragTableView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '616704162@qq.com' => 'caix@mail.open.cn' }
  s.source           = { :git => 'https://github.com/616704162@qq.com/CXDragTableView.git', :tag => s.version.to_s }
